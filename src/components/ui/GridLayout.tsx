...
const GridLayout = ({ isVideo }) => {
    // this below this need to come from BE
//   const call = useCall();
...
//   };
  ...
  return (
    ...
    >
      ...
      >
        {/* Here the all user come and displayed */}
        ...
        <div className="participantViewWrapper"> 
          {
isVideo ? (<video id="preview2" autoPlay className='w-full' />) : (
  <VideoPlaceholder />)
          }
