...
const VideoInterview = ({ visible, setVisible, applicantData, getStageId, fetchJobData, setOfferVisible }) => {
    ...
    const headerContent = (
        <div style={{ borderBottom: "1px solid #E7E7E7" }} className='flex align-items-center justify-content-between'>
            <p className='text-2xl'>Schedule Video Interview</p>
    ...
    return (
        <div>
                            ...
                            <ScrollPanel pt={{ barY: { className: 'bg-primary' } }} style={{ width: '100%', height: '70vh' }} className="custombar1">
                                <Panel style={{ marginBottom: "20px" }} header="Interview Details">
                                    <div className="flex flex-column gap-6">
                                        ...
                                        {/* Meeting URL, ID, and Code */}
                                        <Divider align="center" />
                                        <div className='grid align-items-center'>
                                            <label className='col-4' htmlFor="meetingUrl">
                                                Enter meeting URL: <span className="text-red-500"> *</span>
                                            </label>
                                            <Controller
                                                name="meetingUrl"
                                                control={control}
                                        ...
                                        <div className='grid align-items-center'>
                                            <label className='col-4' htmlFor="meetingId">
                                        ...
                                        <div className='grid align-items-center'>
                                            <label className='col-4' htmlFor="meetingCode">
            ...
            <ComposeModal visible={emailVisible} setVisible={setEmailVisible} emailContent={emailContent} jobApplicationEmail={applicantData?.contactDetails?.contactEmail} technicalPanelEmails={technicalPanelEmails} applicantData={applicantData} getStageId={getStageId} fetchJobData={fetchJobData} setOfferVisible={setOfferVisible} />
        </div>
    );
};
