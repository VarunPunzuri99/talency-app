...
export const accountFields = (parentOrgs, allIndustries, allUsers, countryList, stateList, errors, allaccountTypes, onChangeForPincode) =>[
    {
        title: "Title",
        name: "title",
        type: 'text',
    ...
    },
    {
        ...
        name: "accountType",
        type: 'dropdown',
        options: allaccountTypes.map(accountType =>   ({
