...
import apiService, { setToken } from '@/services/api.service';
...
export async function getServerSideProps({ req, params }) {
    ...
    // let data = null;
    try {
        const data:any  = await apiService.getContactById(params.slug);
        console.log(data)
        // let [todayActivity, upcomingActivity] = await Promise.all([
        //     apiService.getTodayActivity(data?.id),
        //     apiService.getUpcomingActivity(data?.id),
        // ]);
        return {
            props: {
...
export default function ContactDetails(contact) {
    ...
    //         try {
    //             let response:any = await apiService.getContactById(props.slug);
    //             setContact(response);
    //         } catch (error) {
    //             console.error(error);
    //         }
    ...
    return (
        <>
            ...
            <div className={styles.title_bar}>
                <div className={styles.title}>Internal Contacts</div>
                            ...
                            <div className={styles.body}>
                                ...
                                <div className={styles.action_section}>
                                    ...
                                    <div className={styles.box}>
                                        <a
                                            target="_blank"
                                            href={`//api.whatsapp.com/send?phone=${contact.phone}&text=Hi`} rel="noreferrer"
                                        >
                                            <Image
                                                alt="whatsapp"
