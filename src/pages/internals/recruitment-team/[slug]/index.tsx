...
export default function ContactDetails(props) {
    ...
    const [contact, setContact] = useState<BasicUser | null>(null);
    const filters = [{ name: 'Today & upcoming', code: 'NY' }];
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await apiService.getContactById(props.slug);
                // setContact(response);
            } catch (error) {
                console.error(error);
            }
    ...
    return (
        <>
            ...
            <div className={styles.title_bar}>
                <div className={styles.title}>Recruitment Team</div>
                        ...
                        <div className={styles.card}>
                            ...
                            <div className={styles.body}>
                                <div className={styles.name_box}>
                                    {contact.fullName?.toUpperCase()?.substring(0, 1)}
                                ...
                                <div className={styles.action_section}>
                                    ...
                                    <div className={styles.box}>
                                        <a
                                            target="_blank"
                                            href={`//api.whatsapp.com/send?phone=${contact.contactNumber}&text=Hi`} rel="noreferrer"
                                        >
                                            <Image
                                                alt="whatsapp"
